        ...
        <div class="layui-container">
            ...
            <div class="layui-row item">
                ...
                <div class="layui-col-md9">
                        ...
                        <div class="layui-carousel" id="carousel">
                            <div carousel-item>
                                <c:if test="${not empty item.pic1}">
                                    <div><img src="/api/image/${item.pic1}" alt=""></div>
                                </c:if>
                                <c:if test="${not empty item.pic2}">
                                    <div><img src="/api/image/${item.pic2}" alt=""></div>
                                </c:if>
                                <c:if test="${not empty item.pic3}">
                                    <div><img src="/api/image/${item.pic3}" alt=""></div>
                                </c:if>
                    ...
                    <div class="layui-col-md6 iteminfo">
                        <div class="layui-row">
                ...
                <div class="layui-col-md3">
                    <div class="user">
                        ...
                        <img class="user-img"
                        <c:choose>
                             <c:when test="${not empty item.user.avatar}">src="/api/image/${item.user.avatar}"</c:when>
...
<script src="/js/trade/detail.js"></script>
</html>
