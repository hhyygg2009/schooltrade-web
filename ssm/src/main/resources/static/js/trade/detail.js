...
<div class="comment-line-box" ${commentData}>
    <div>
        <img class="avatar" ${data.user.avatar} alt=""><span>${data.user.username}</span>
        <p>${htmlEscape(data.content)}</p>                        
...
//     <div>
//         <img class="avatar" src="/api/image/${data.user.avatar}" alt=""><span>${data.user.username}</span>
//         <p>${data.content}</p>
//         <a href="#" class="reply-btn">回复</a> <a href="#" class="delete-btn">删除</a> <a href="">举报</a>
//     </div>
